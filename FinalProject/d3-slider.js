// This is a modified version of the following slider from
// https://github.com/johnwalley/d3-simple-slider Version 0.2.0. Copyright 2017 John Walley.
// which build from an initial example by mike bostock

// we changed sizes and layout, but keept the animation/dragging and internal get/set functions as they where
...
function slider() {
  var value = 1977;
  var defaultValue = 1977;
  var domain = [0, 0];
  var width = 100;
  var displayValue = true;
  var handle = "M-5.5,-5.5v10l6,5.5l6,-5.5v-10z"; // defining that shape of the handle
  var step = null;
  var tickValues = null;
  var marks = null;
  var tickFormat = null;
  ...
  function slider(context) {
    ...
    sliderEnter
      ...
      .attr("y2", 0)
      .attr("stroke", "#bbb")
      .attr("stroke-width", 0) // removed som ugly gray part of slider by setting with to 0
    ...
    context.selectAll(".axis line").attr("stroke", "blue").attr("y1", 0).attr("y2", 10); // changed tick sizes
